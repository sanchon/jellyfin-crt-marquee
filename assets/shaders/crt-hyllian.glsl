...
// Parametros convertidos a #define: la build de mpv que usa Jellyfin
// Media Player no soporta la directiva de parametros (falla con
// "Unrecognized command" y el shader entero no carga). Importante: el
// texto antes del primer bloque HOOK no se comparte entre pasadas, asi
// que los #define van dentro del bloque HOOK que los usa (la 2da pasada).
