...
// Parametros convertidos de //!PARAM a #define: la build de mpv que usa
// Jellyfin Media Player no soporta la directiva //!PARAM (falla con
// "Unrecognized command 'PARAM ...'" y el shader entero no carga).
